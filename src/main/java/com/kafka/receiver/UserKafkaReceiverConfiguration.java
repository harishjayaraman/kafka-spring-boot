...
@Configuration
@EnableKafka
public class UserKafkaReceiverConfiguration {
	...
	public Map<String, Object> consumerConfigs() {
		...
		props.put("value.deserializer", UserKafkaDeserializer.class.getName());
    ...
    @Bean
    public UserKafkaReceiver userKafkaReceiver() {
        return new UserKafkaReceiver();
    }
}
